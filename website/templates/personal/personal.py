...
from website.templates.personal.process_personal import generate_code
...
def wifi():
    if request.method == 'POST':
        ...
        db.session.commit()
    # TODO: Find out why I can not add new wifis on website/production version of the program
